...
namespace Clc.Polaris.Api.Tests
{
    ...
    public class PapiClientTests
    {
        ...
        //{
        //    var response = papi.ItemUpdateBarcodeAsync("1234", 1234);
        ...
        //{
        //    var response = papi.PatronRegistrationCreateAsync(new PatronRegistrationParams());
        //    Assert.IsTrue(response.Data.PAPIErrorCode == -1);
        //}
        ...
        //{
        //    var response = papi.RemoteStorageItemsGetAsync(7, "asdf", "asdf", 1, 1);
        //    Assert.IsTrue(response.Data.PAPIErrorCode == -1);
        //}
