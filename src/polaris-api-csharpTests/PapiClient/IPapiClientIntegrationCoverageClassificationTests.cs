...
namespace Clc.Polaris.Api.Tests
{
    ...
    public sealed class IPapiClientIntegrationCoverageClassificationTests
    {
        ...
        private static readonly Dictionary<string, MethodCoverage> Classifications = new()
        {
            ...
            [nameof(IPapiClient.ItemCheckInPostAsync)] = new(LiveCoverageClassification.UnitOnly, "Mutating circulation action; covered by request-shape and validation tests."),
            [nameof(IPapiClient.ItemCheckOutPostAsync)] = new(LiveCoverageClassification.UnitOnly, "Mutating circulation action; covered by request-shape and validation tests."),
