...
namespace Clc.Polaris.Api.Tests.TestInfrastructure
{
    ...
    {
        [TestInitialize]
        public void PapiClientTestBaseInitialize()
        {
            ClearProtectedTokenState();
        }

        protected static global::Clc.Polaris.Api.PapiClient CreateClient(HttpMessageHandler? handler = null)
        {
        ...
        protected static global::Clc.Polaris.Api.PapiClient CreateClient(CaptureHttpMessageHandler handler)
        {
        ...
        protected static global::Clc.Polaris.Api.PapiClient CreateClient(CapturingHttpMessageHandler handler)
        {
            var httpClient = new HttpClient(handler)
            {
            ...
            return new global::Clc.Polaris.Api.PapiClient(httpClient, null)
            {
                Hostname = "https://example.test",
                AccessID = "access-id",
        ...
        protected static global::Clc.Polaris.Api.PapiClient CreateProtectedClient(ProtectedTokenHttpMessageHandler handler)
        {
            return CreateProtectedClient(handler, $"https://example-{Guid.NewGuid():N}.test", CreateStaffUser());
        }

        protected static global::Clc.Polaris.Api.PapiClient CreateProtectedClient(ProtectedTokenHttpMessageHandler handler, string hostname, PolarisUser staffUser)
        {
            var httpClient = new HttpClient(handler)
            {
        ...
        protected static global::Clc.Polaris.Api.PapiClient CreateClientWithProtectedCache(HttpMessageHandler handler, string username)
        {
        ...
        protected static async Task ExecuteRawPapiRequestAsync(global::Clc.Polaris.Api.PapiClient client, PapiRestRequest request)
        {
        ...
        {
            var isStaffAuthenticatorRequest = typeof(global::Clc.Polaris.Api.PapiClient)
        ...
        {
            var cacheProperty = typeof(global::Clc.Polaris.Api.PapiClient).GetProperty(propertyName, BindingFlags.NonPublic | BindingFlags.Static);
        ...
        protected static string? BuildCacheKey(string hostname, string accessId, string accessKey, PolarisUser? staffUser)
        {
            ...
            var client = new global::Clc.Polaris.Api.PapiClient
            {
                Hostname = hostname,
                AccessID = accessId,
                AccessKey = accessKey,
        ...
        protected static string? BuildCacheKey(global::Clc.Polaris.Api.PapiClient client)
        {
            var buildCacheKeyMethod = typeof(global::Clc.Polaris.Api.PapiClient).GetMethod("BuildProtectedTokenCacheKey", BindingFlags.Instance | BindingFlags.NonPublic)
