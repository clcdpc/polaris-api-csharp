...
namespace Clc.Polaris.Api
{
    public interface IPapiClient
    {
        ...
        Task<IRestResponse<BibGetByTypeResult>> BibGetByTypeV2Async(string key, string type = "barcode", int? branchId = null, CancellationToken cancellationToken = default);
        ...
        Task<IRestResponse<HeadingsSearchResult>> HeadingsSearchAsync(SearchQualifiers qualifierName, int numberOfTerms, int preferredPosition, string? startPoint = null, int? noTransaction = null, int? branchId = null, CancellationToken cancellationToken = default);
        ...
        Task<IRestResponse<PapiResponseCommon>> RequestsUpdateStatusAsync(int requestId, RequestStatusAction action, int? itemId = null, int? denyReason = null, int? organizationId = null, CancellationToken cancellationToken = default);
