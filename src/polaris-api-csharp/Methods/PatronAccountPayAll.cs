...
namespace Clc.Polaris.Api
{
    ...
    {
        public async Task<IRestResponse<PatronAccountPayResult>> PatronAccountPayAllAsync(string barcode, double txnAmount, PaymentMethod paymentMethod, int? workstationId = null, int? userId = null, string note = "", CancellationToken cancellationToken = default)
        {
