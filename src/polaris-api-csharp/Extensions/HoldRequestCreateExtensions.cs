...
namespace Clc.Polaris.Api
{
    ...
    {
        public static Task<IRestResponse<HoldRequestCreateResult>> HoldRequestCreateAsync(this IPapiClient client, int patronId, int bibId, int pickupBranchId = 0, DateTime? activationDate = null, int? userId = null, int? workstationId = null, int? requestingOrgId = null, CancellationToken cancellationToken = default)
        {
