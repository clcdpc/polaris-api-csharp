...
namespace Clc.Polaris.Api.UnitTests.AuthenticationAndTokens.ProtectedTokenAcquisition.ProtectedToken
{
    [TestClass]
    [DoNotParallelize]
    [UnitTest]
    public class PatronSearchTests : PapiClientUnitTestBase
    {
        ...
        public async Task ProtectedTokenAcquisition_CanceledWaiterDoesNotHoldCacheLock()
        {
            ...
            Assert.IsFalse(handler.ProtectedRequests[1].RequestUri!.AbsoluteUri.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal));
        }
