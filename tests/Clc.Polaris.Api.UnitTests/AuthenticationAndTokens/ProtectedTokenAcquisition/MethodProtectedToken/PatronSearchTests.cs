...
namespace Clc.Polaris.Api.UnitTests.AuthenticationAndTokens.ProtectedTokenAcquisition.MethodProtectedToken
{
    [TestClass]
    [DoNotParallelize]
    [UnitTest]
    public class PatronSearchTests : PapiClientUnitTestBase
    {
        ...
        public async Task ProtectedTokenPathRequest_ReplacesPlaceholderBeforeSending()
        {
            ...
            client.Token = new global::Clc.Polaris.Api.Models.ProtectedToken { AccessToken = "real-token", AccessSecret = "real-secret", ExpirationDate = ValidProtectedTokenExpirationDate };
            ...
            Assert.IsFalse(handler.LastRequest!.RequestUri!.AbsoluteUri.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal));
        ...
        public async Task ProtectedTokenPathRequest_HashesReplacedUrlInsteadOfPlaceholderUrl()
        {
            var handler = new CapturingHttpMessageHandler(CreatePapiResponseJson());
            var client = CreateClient(handler);
            client.Token = new global::Clc.Polaris.Api.Models.ProtectedToken { AccessToken = "hash-token", AccessSecret = "hash-secret", ExpirationDate = ValidProtectedTokenExpirationDate };
            ...
            var placeholderUri = expectedUri.Replace("hash-token", global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal);
        ...
        public async Task ProtectedTokenPathRequest_AcquiresProtectedTokenAutomaticallyWhenMissing()
        {
            ...
            Assert.IsFalse(handler.Requests[1].RequestUri!.AbsoluteUri.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal));
        }
        ...
        public async Task ProtectedTokenPathRequest_WithExpiredToken_AcquiresProtectedTokenBeforePlaceholderReplacement()
        {
            ...
            client.Token = new global::Clc.Polaris.Api.Models.ProtectedToken
            {
        ...
        public async Task ProtectedTokenPathRequest_UsesCachedProtectedTokenForPlaceholderReplacement()
        {
            ...
            Assert.IsFalse(handler.Requests[2].RequestUri!.AbsoluteUri.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal));
        }
        ...
        public async Task PatronSearchAsync_ConcurrentProtectedRequestsAcrossClientsForSameCacheKey_AuthenticateOnceAndUseSharedToken()
        {
            ...
            foreach (var request in finalRequests)
            {
                ...
                Assert.IsFalse(request.Path.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal));
        ...
        {
            var hostname = $"https://example-{Guid.NewGuid():N}.test";
            var passwordAToken = new global::Clc.Polaris.Api.Models.ProtectedToken
            {
                AccessToken = "token-for-password-a",
                AccessSecret = "secret-for-password-a",
                ExpirationDate = ValidProtectedTokenExpirationDate
            };
            var passwordBToken = new global::Clc.Polaris.Api.Models.ProtectedToken
            {
        ...
        public async Task PatronSearchAsync_WhenProtectedTokenCacheDisabled_IgnoresStaticCachedTokenAndUsesNewAuthenticationToken()
        {
            ...
            SetCachedToken(client.Hostname, client.AccessID, client.AccessKey, client.StaffOverrideAccount, new global::Clc.Polaris.Api.Models.ProtectedToken
            {
        ...
        public async Task PatronSearchAsync_ProtectedTokenPlaceholder_ReplacesPlaceholderAfterSuccessfulTokenAcquisitionAndSignsFinalPath()
        {
            ...
            Assert.DoesNotContain(request => request.Path.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal), capturedRequests);
            ...
            var placeholderUri = capturedRequests[1].AbsoluteUri.Replace("placeholder-token", global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal);
        ...
        {
            var returnedToken = new global::Clc.Polaris.Api.Models.ProtectedToken
            {
            ...
            Assert.AreEqual(1, handler.AuthenticationRequestCount);
            Assert.AreEqual(0, handler.NonAuthenticationRequestCount);
            Assert.DoesNotContain(path => path.Contains(global::Clc.Polaris.Api.Models.ProtectedToken.Placeholder, StringComparison.Ordinal), handler.RequestPaths);
        }
