...
namespace Clc.Polaris.Api.UnitTests.Governance
{
    [TestClass]
    [UnitTest]
    public sealed class IPapiClientIntegrationCoverageClassificationTests
    {
        ...
        private static readonly Dictionary<string, MethodCoverage> Classifications = new()
        {
            ...
            [nameof(IPapiClient.BibsPostAsync)] = new(LiveCoverageClassification.NotLiveTestedWithReason, "Imports bibliographic records and creates import jobs; covered by request-shape and model tests."),
            ...
            [nameof(IPapiClient.ILLRequestPostAsync)] = new(LiveCoverageClassification.NotLiveTestedWithReason, "Creates ILL requests; covered by request-shape and model tests."),
            ...
            [nameof(IPapiClient.JobsPurchaseOrdersPutAsync)] = new(LiveCoverageClassification.NotLiveTestedWithReason, "Validates acquisition purchase-order job data and depends on environment-specific acquisitions setup; covered by request-shape and model tests."),
            [nameof(IPapiClient.JobsPurchaseOrdersPostAsync)] = new(LiveCoverageClassification.NotLiveTestedWithReason, "Creates acquisition purchase-order jobs; covered by request-shape and model tests."),
            [nameof(IPapiClient.JobsPurchaseOrdersResultGetAsync)] = new(LiveCoverageClassification.NotLiveTestedWithReason, "Requires a known purchase-order job GUID; covered by request-shape and model tests."),
            [nameof(IPapiClient.JobsPurchaseOrdersStatusGetAsync)] = new(LiveCoverageClassification.NotLiveTestedWithReason, "Requires a known purchase-order job GUID; covered by request-shape and model tests."),
